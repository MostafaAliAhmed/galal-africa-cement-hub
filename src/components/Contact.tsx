    ...
    <section id="contact" className="py-24 bg-blue-50">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-blue-800 mb-4">Contact Us</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">Cairo Nasr City, Egypt</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">+201210101133</p>
                    <p className="text-blue-100 text-sm mt-1">WhatsApp available at the same number</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100">GalalExporting@Gmail.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    ...
                    <p className="text-blue-100">9:00 AM - 5:00 PM (EET)</p>
                  </div>
                  <div>
                    <p className="font-medium">Saturday:</p>
                    <p className="text-blue-100">9:00 AM - 1:00 PM (EET)</p>
                  </div>
                </div>
              </div>
